...
CREATE TABLE userd (
id INT(15) UNSIGNED  NOT NULL PRIMARY KEY,
...
id INT(15) UNSIGNED NOT NULL PRIMARY KEY,
biography TEXT,
userd_id INT(15) UNSIGNED NOT NULL,
created TIMESTAMP DEFAULT CURRENT_TIMESTAMP(),
updated TIMESTAMP DEFAULT CURRENT_TIMESTAMP(),
ipaddress VARCHAR(255),
CONSTRAINT author_FK1 FOREIGN KEY (userd_id) REFERENCES userd(id) ON UPDATE CASCADE
); 
