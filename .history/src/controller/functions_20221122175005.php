...
$userdata = array();
if(!empty($userdata)){$userdata = ['email'=>$_POST['email'], 'password'=>$_POST['password']];}
...
$newdata = array();
if(!empty($newdata)){$newdata = ['title'=>$_POST['title'],'description'=>$_POST['description'],'content'=>$_POST['content'],'category_id'=>$_POST['category_id'],
...
$newdata = array();
if(!empty($newdata)){
$newdata = ['userdata_id'=>$_POST['userdata_id'],'biography'=>$_POST['biography'], 
'ipaddress'=>$_POST['ipaddress']];
}
if(isset($_SESSION['firstname']) && isset($_SESSION['lastname'])){
