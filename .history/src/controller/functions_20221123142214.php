...
$results['success']  = $user->readUser($userdata);
...
$userdata = array();
if(isset($_POST['username']) && isset($_POST['firstname']) && !empty($_POST['lastname']) && 
!empty($_POST['email']) && !empty($_POST['password']) && !empty($_POST['ipaddress'])){
...
$user = new Userdata($userdata);
$results['checkemail'] = $user->readUser($_POST['email']);
