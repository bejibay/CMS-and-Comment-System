...
&& isset($data['ipaddress'])){$url = $this->getSEOurl($data['title']);
...
$result = $this->update("UPDATE staticpage SET id=:id,title=:titlde,description=:description,content=:content, created:created,updated=:updated, ipaddress=:ipaddres WHERE id =:id",["id"=>$this->id,"url"=>$this->url,
