...
public function createADynamicPage($data=[]){
    ...
    $result =  $this->insert("INSERT INTO dynamicpage(url,title , description, content,media_id,author_id,
    created,updated,ipaddress)VALUES(:url,:title,:description,:content,:media_id,:author_id,
    :created,:updated,:ipaddress)",["url"=>$this->url,"title"=>$this->title,"description"=>$this->description,"content"=>$this->content,"media_id"=>$this->media_id,"author_id"=>$this->author_id ,"created"=>$this->created,"updated"=>$this->updated,
