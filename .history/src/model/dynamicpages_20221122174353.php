...
&& isset($data['author_id'])){ $this->url = $this->getSEOurl($data['title']);
$result =  $this->insert("INSERT INTO dynamicpage(url,title, description, content,category_id,author_id,
created,updated,ipaddress)VALUES(:url,:title,:description,:content,:category_id,:author_id,
:created,:updated,:ipaddress)",["url"=>$this->url,"title"=>$this->title,
"description"=>$this->description,"content"=>$this->content,"category_id"=>$this->category_id,"author_id"=>$this->author_id ,"created"=>$this->created,"updated"=>$this->updated,
