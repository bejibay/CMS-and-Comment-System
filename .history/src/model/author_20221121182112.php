...
public function createAuthor($data= []){
    $this->userdata_id =$_SESSION['userdata_id'];
    if(isset($data['biography']) && isset($data['created'])){
$result = $this->insert("INSERT INTO author(`biography`,`userdata_id`,`created`,`updated`,`ipaddress`)VALUES(:biography,:user_id,
:created, :updated,:ipaddress)",["biography"=>$this->biography,"user_id"=>$this->userdata_id,"created"=>$this->created,
