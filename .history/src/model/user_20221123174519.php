...
if($result1)return $result1['password'];
if($result1['password']) && password_verify($data['password'], $result1['password']){return $result1}
$result2 = $result1['password'];
if(isset($result2)){if(password_verify($data['password'], $result1['password']));return $result1;}
else{return false;}
}
}
