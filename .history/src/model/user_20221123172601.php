...
if(isset($result1)){if(password_verify($data['password'], $result1['password']));}
if(isset($result1['password']) && password_verify($data['password'], $result1['password']))return $result1;
else{return false;}
}
}
