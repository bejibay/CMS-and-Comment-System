...
<div class="column leftside">
 ...
 <?php if(isset($results['firstname'])){echo $result['firstname'];}?>
 <?php if(isset($results['lastname'])){echo $result['lastname'];}?>
 <?php if(isset($_SESSION['lastname'])){echo $result['lastname'];}?>
</div>
